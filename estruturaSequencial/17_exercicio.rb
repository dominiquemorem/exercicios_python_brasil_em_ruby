...
puts "Seriam necessárias #{bigCans(paintedArea)} latas grandes. Resultando em um total de: #{sprintf("%.2f", bigCans(paintedArea) * 80.00)}"
puts "Seriam necessárias #{smallCans(paintedArea)} latas pequenas. Resultando em um total de: #{sprintf("%.2f", smallCans(paintedArea) * 25.00)}"
